...
detalles.](IPCC_Methodology_Tiers_cowfootR_files/figure-html/unnamed-chunk-8-1.png)
...
![Figura generada por la viñeta; ver texto para
detalles.](IPCC_Methodology_Tiers_cowfootR_files/figure-html/unnamed-chunk-13-1.png)
...
![Figura generada por la viñeta; ver texto para
detalles.](IPCC_Methodology_Tiers_cowfootR_files/figure-html/unnamed-chunk-17-1.png)
...
1.  **Tier differences**: Tier 2 typically shows 5-15% different results
    from Tier 1, with the direction depending on specific farm
    characteristics.

2.  **Source-specific impacts**: Enteric fermentation shows the largest
    differences between tiers, while energy and soil sources remain
    relatively unchanged.

3.  **Data investment**: Tier 2 requires 3-5x more data collection time
    but provides 2-3x better accuracy.

4.  **Management relevance**: Tier 2 better captures farm-specific
    management practices and their environmental impacts.
